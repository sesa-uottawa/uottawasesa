...
describe MainsController do
  ...
  describe "GET new" do
    it "assigns a new main as @main" do
      ...
      assigns(:main).should be_a_new(Main)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved main as @main" do
        ...
        Main.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested main" do
        ...
        Main.any_instance.should_receive(:update).with({ "these" => "params" })
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the mains list" do
      main = Main.create! valid_attributes
      delete :destroy, {:id => main.to_param}, valid_session
      response.should redirect_to(mains_url)
    end
  end
