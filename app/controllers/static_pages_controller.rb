    ...
    @current_members = [
      {
        ...
        lastName: 'Opolski',
        role: 'President',
        imgUrl: view_context.asset_path('current_members/nel.jpg').to_s,
      ...
      },
      {
        ...
        lastName: 'Olubode',
        role: 'Vice President',
        imgUrl: view_context.asset_path('current_members/tolu.jpg').to_s,
      ...
      },
      {
        ...
        lastName: 'Kung',
        role: 'VP Academic',
        imgUrl: view_context.asset_path('current_members/kyle.png').to_s,
        yearsActive: '2015-present'
      },
      {
        firstName: 'Anthony A.',
        lastName: 'Nader',
        role: 'VP Marketing',
        imgUrl: view_context.asset_path('current_members/anthony.png').to_s,
      ...
      },
      {
        ...
        imgUrl: view_context.asset_path('current_members/jonathon.jpg').to_s,
      ...
      },
      {
        ...
        lastName: 'Compoare',
        role: 'VP Finance',
        imgUrl: view_context.asset_path('current_members/leila.jpg').to_s,
        yearsActive: '2015-present'
      },
      {
        firstName: 'Anushka',
        lastName: 'Paliwal',
        role: 'Very Social Exec',
        imgUrl: view_context.asset_path('default-female-photo.jpg').to_s,
        yearsActive: '2016-present'
      },
      {
        firstName: 'Amelie',
